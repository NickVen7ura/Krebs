...
@WebServlet(name = "reportePadre", urlPatterns = {"/reportePadre"})
public class reportePadre extends HttpServlet {
            ...
            try{
                ...
                if(con!=null){
                    try{
                        ...
                        par1.add(new Phrase("Reporte de Padres - Clinica Dental KREBS 🦷", ft));
                        ...
                        float[] columnWidths = {3f, 5f, 4f, 5f,4f,9f};
                        ...
                        PdfPCell celda3 = new PdfPCell(new Paragraph("DNI", FontFactory.getFont("Arial",12,Font.BOLD,BaseColor.BLUE)));                                                          
                        PdfPCell celda4 = new PdfPCell(new Paragraph("Direccion", FontFactory.getFont("Arial",12,Font.BOLD,BaseColor.BLUE)));
                        PdfPCell celda5 = new PdfPCell(new Paragraph("Telefono", FontFactory.getFont("Arial",12,Font.BOLD,BaseColor.BLUE)));
                        PdfPCell celda6 = new PdfPCell(new Paragraph("Email", FontFactory.getFont("Arial",12,Font.BOLD,BaseColor.BLUE)));
